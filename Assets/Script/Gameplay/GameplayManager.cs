...
public class GameplayManager : MonoBehaviour
{
    ...
    public void StartGame()
    {
        ...
        {
            case Weather.Sunny:
                OptionWidget.GetVolumeComponent<VolumetricClouds>().cloudPreset = CloudPresets.Sparse;
                break;
            case Weather.Overcast:
                OptionWidget.GetVolumeComponent<VolumetricClouds>().cloudPreset = CloudPresets.Overcast;
                break;
            case Weather.Stormy:
                OptionWidget.GetVolumeComponent<VolumetricClouds>().cloudPreset = CloudPresets.Stormy;
                break;
        }
